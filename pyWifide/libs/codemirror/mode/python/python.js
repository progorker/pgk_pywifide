...
"pytestor.api_testor_version"
    ...
    if (py3) {
      ...
      myBuiltins = myBuiltins.concat(["ascii", "bytes", "exec", "print"], g_api);
      ...
      myBuiltins = myBuiltins.concat(["apply", "basestring", "buffer", "cmp", "coerce", "execfile",
                                      ...
                                      "unichr", "unicode", "xrange", "None"], g_api);
    ...
    function tokenBaseInner(stream, state, inFormat) {
      ...
      if (stream.match(/^#username /, false)) {
        var wd = '#username ';
        for (var i = 0; i < wd.length; i++ ) {
          stream.eat(wd[i]);
        }
      ...
      if (stream.match(/^#password /, false)) {
        var wd = '#password ';
        for (var i = 0; i < wd.length; i++ ) {
          stream.eat(wd[i]);
        }
